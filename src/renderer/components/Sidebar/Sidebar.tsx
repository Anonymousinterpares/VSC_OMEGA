...
import { Files, Search, Settings, FolderOpen, MoreVertical } from 'lucide-react';
        ...
        <div className="flex h-full w-full">
            ...
            <div className="w-12 flex flex-col items-center py-4 bg-[#333333] border-r border-gray-800 text-gray-400">
                <button 
                    ...
                    className={clsx("p-2 mb-2 rounded hover:text-white relative", activeView === 'explorer' && "text-white")}
                    title="Explorer"
                >
                    <Files size={24} strokeWidth={1.5} />
                    {activeView === 'explorer' && <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-white" />}
                </button>
                <button 
                    onClick={() => setActiveView('search')}
                    className={clsx("p-2 mb-2 rounded hover:text-white relative", activeView === 'search' && "text-white")}
                    title="Search"
                >
                    <Search size={24} strokeWidth={1.5} />
                    {activeView === 'search' && <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-white" />}
                </button>
